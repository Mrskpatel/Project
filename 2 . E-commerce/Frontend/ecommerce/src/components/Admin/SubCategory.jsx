...
function SubCategory() {
  ...
  useEffect(() => {
    ...
    const fatchingdata = () => {
      axios.get('http://localhost:1085/Category/viewCategory')
        .then((res) => {
  ...
  const handleSubmit = async (e) => {
    ...
    e.preventDefault()
    await axios.post('http://localhost:1085/subCategory/addSubCategory', { subCategoryName , "CategoryId" : selectedCategory })
      .then((res) => {
        console.log(res);
              ...
              <div className="container-fluid">
                <div className="card">
                  <div className="card-body">
                    <h5 className="card-title fw-semibold mb-4">Sub Category</h5>
                    <div className="card">
                      <div className="card-body">
                        <form onSubmit={handleSubmit}>
                          <div className="mb-3">
                            <label className="form-label">Sub Category </label>
                            <input type="text" className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" onChange={(e)=> setsubCategoryName(e.target.value)} />
                          </div>
                          <div className='mb-3'>
                            <label className="form-label">Category</label>
                            <select value={selectedCategory} onChange={handleCategoryChange} className="form-control" id="exampleInputEmail1 category" aria-describedby="emailHelp">
                            <option value="" disabled selected>Select a Category</option>
                              {
                               data.map((el, i) => {
                               return <option value={el._id} key={i}>
                                {el.CategoryName}
                              </option>
                              })
                              }
